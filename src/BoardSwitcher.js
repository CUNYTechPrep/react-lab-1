...
//it can contain any number of properties; to refer to the state object anywhere in the component us this.state.propertyName and its referred to in the render method
...
//super keyword will call the methods of the super class in this react.component 
...
//we can just create the state object on our own 
